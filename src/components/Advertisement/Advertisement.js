...
const Advertisement = ({ content = '', isShowAdvertising, setIsShowAdvertising, autoShow = true, showRedirect = true, onCover = false }) => {
    ...
    return (
        <Modal className="w-11/12 md:w-4/6 lg:w-3/6 h-[calc(100%-300px)] md:h-[calc(100%-120px)]" onCover={onCover} open={isShowAdvertising} onClose={() => setIsShowAdvertising(false)}>
            ...
            <div className="flex flex-col w-full h-full py-4 overflow-hidden overscroll-y-auto">
