    ...
    return (
        <div className={`${isOpen || 'translate-x-full'} bg-pink-100 w-[320px] h-screen z-30 fixed top-0 transition-all duration-300 ease-in-out -right-5 bottom-0 drop-shadow-lg shadow-black text-slate-800 dark:bg-[--primary-bg-dark-color-1] dark:text-white overflow-y-auto`}>
            <div className="flex flex-col ">
                <div className="flex flex-row items-center justify-between pr-8 h-[100px] border-b-2 border-white/75 dark:bg-[--primary-dark-color] px-1">
                ...
                <div className="flex flex-col w-full pl-4 md:text-base text-lg my-2 pb-2 border-b-2 border-white/75 dark:bg-[--primary-bg-dark-color-1] dark:text-white">
                ...
                <div className="flex flex-col w-full gap-4 pl-4 pr-8 text-lg dark:bg-[--primary-bg-dark-color-1] dark:text-white">
