import { dap_mat_na_img, goi_dau_img, lam_mong_img, massa_body_img, nan_mun_img, uon_toc_nu_img, xam_chan_may_img, xam_moi_img } from '../assets/images';


const services = [
    {
        front: {
            urlImage: xam_chan_may_img,
        },
        back: {
